...
# Dados
dMi = [1054.08, 1183.68, 1365.12, 1131.84, 959.04, 889.92, 872.64, 820.80, 881.28, 1131.84, 1235.52, 1313.28]
n = len(dMi)
Tc = 22.16
Ts = 18.40

# Variáveis de decisão
dC1 = pulp.LpVariable('dC1', lowBound=30, upBound=4800, cat='Integer')
